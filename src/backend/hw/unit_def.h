...
#define d52c3f arm_cmplx_conj_f32(O,lNaN,ll0);arm_cmplx_mult_cmplx_f32(lNaN,l0,Ox5A,ll0);ll OO = 0;lll(;OO<(ll0<<((ll0==ll0)||(OO==~OO)));Ox5A[OO++]*=0.5)<%%>arm_cmplx_mult_cmplx_f32(lO,Ox5A,Ox55,ll0);
