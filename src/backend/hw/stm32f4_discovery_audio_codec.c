...
uint32_t AudioTotalSize = 0; /* This variable holds the total size of the audio file. Initialize to zero to trigger transfer complete interrupt immediately. */
uint32_t AudioRemSize   = 0; /* This variable holds the remaining data in audio file. Initialize to zero to trigger transfer complete interrupt immediately. */
